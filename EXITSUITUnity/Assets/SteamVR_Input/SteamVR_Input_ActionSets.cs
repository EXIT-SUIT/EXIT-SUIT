...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_exitGloves p_exitGloves;
        ...
        public static SteamVR_Input_ActionSet_exitGloves exitGloves
        {
            get
            {
                return SteamVR_Actions.p_exitGloves.GetCopy<SteamVR_Input_ActionSet_exitGloves>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_exitGloves = ((SteamVR_Input_ActionSet_exitGloves)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_exitGloves>("/actions/exitGloves")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.exitGloves};
        }
    }
}
